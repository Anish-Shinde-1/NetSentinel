...
# IP Blocking
tk.Label(root, text="Block by IP:", bg="#f0f0f0").pack()
ip_entry = ttk.Entry(root, width=30)
ip_entry.pack()

# Application Blocking
tk.Label(root, text="Block by Application:", bg="#f0f0f0").pack()
app_entry = ttk.Entry(root, width=30)
app_entry.pack()
ttk.Button(root, text="Browse", command=browse_app).pack()

# Port Blocking
tk.Label(root, text="Block by Protocol and Port:", bg="#f0f0f0").pack()
...
# Blocked Listbox
tk.Label(root, text="Blocked Rules:", bg="#f0f0f0").pack()
